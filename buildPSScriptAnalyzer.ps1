...
function ConvertResxStringsToCsharp {
    ...
    if ($PSCmdlet.ShouldProcess($Destination, 'Create File')) {
        ...
        &{
            ...
            ""
            "                for (var culture = culturePreferred; culture != CultureInfo.InvariantCulture; culture = culture.Parent)"
            "                {"
            ...
            "                }"
            ""
            "                culturePreferredData.Add(_localizedResources[CultureInfo.InvariantCulture]);"
            ""
